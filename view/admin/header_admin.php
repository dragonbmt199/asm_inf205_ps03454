...
<body>
   	<header><!-- Phần header --> 
        <a class="logo" href="?action=cpanel"><img src="../view/img/logo.jpg" /></a>
	...
	<ul>
        ...
        <?php
            if(isset($_SESSION['Administrator'])){
                ...
                <a class='a_account' href=''>Wellcome $username</a>
                </li>
                <li class='cart'>
                <a class='a_account' href=''>Giỏ hàng:</a> <span class='color_999'>(trống)</span>
                </li>
                <li class='login'>( <a href='?action=logout_admin'>Đăng xuất</a> )</li>
                </ul>";
            }  else { echo"
               <ul>
                <li class='your_account'>
