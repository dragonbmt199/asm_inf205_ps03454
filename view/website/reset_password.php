<?php include '../view/website/header.php'; ?>
    ...
    ?>   
            <form name="DangNhap" method="post" action="?action=reset_password_action">
  ...
  <tr>
    ...
    <td width="380"><input name="email" type="email"  size="28" value=""/> </td>
  </tr>
      <td>&nbsp;</td>
  ...
  <tr>
  <td>&nbsp;</td>
  <td><input id="ip_sm" name="reset_pw" type="submit" value="Gửi" /> 
