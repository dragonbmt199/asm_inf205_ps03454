<?php include '../view/website/header.php'; ?>
    ...
    ?>   
            <form name="DangNhap" method="post" action="?action=change_password_action">
            <table width="530" border="1" cellpadding="0" cellspacing="5" id="tb"> 
     <tr>
    <td width="135">Tên đăng nhập:</td>
    <td width="380"><input name="username" type="text"  size="28" value=""/> </td>
  </tr>
  <tr>
    <td width="135">Mật khẩu cũ: </td>
    <td width="380"><input name="password" type="password"  size="28" value=""/> </td>
  </tr>
  <tr>
      <td width="135">Mật khẩu mới: </td>
    <td width="380"><input name="newpassword" type="password"  size="28" value=""/> </td>
  </tr>
  <tr>
      <td width="135">Nhập lại mật khẩu: </td>
    <td width="380"><input name="renewpassword" type="password"  size="28" value=""/> </td>
  </tr>
  <tr>
      <td>&nbsp;</td>
  ...
  <tr>
  <td>&nbsp;</td>
  <td><input id="ip_sm" name="change_pw" type="submit" value="Gửi" /> 
