   	...
   	<header><!-- Phần header --> 
        ...
        <?php
            if(isset($_SESSION['check'])){
                ...
                <a class='a_account' href='?action=change_password'>Wellcome $username</a>
                </li>
                <li class='cart'>
                <a class='a_account' href='?action=show_cart'>Giỏ hàng:</a> <span class='color_999'>(trống)</span>
                </li>
                <li class='login'>( <a href='?action=logout'>Đăng xuất</a> )</li>
                </ul>";
            }  else { echo"
               <ul>
                <li class='your_account'>
